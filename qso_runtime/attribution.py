...
class AttributionJourneyLedger:
    ...
    def append(
        ...
        *,
        event_type: str,
        contributors: list[ContributorCredit],
        ...
        benefit_sharing_reference: str | None = None,
        sprite_reviewed: bool = False,
        ...
        body = {
            "schema_version": 1,
            "qso_instance": self.qso_instance,
            "sequence": sequence,
            ...
            "terms": {
                ...
                "benefit_sharing_reference": benefit_sharing_reference,
            },
            "review": {
                "sprite_reviewed": sprite_reviewed,
    ...
    def certificate(self) -> dict[str, Any]:
        return {
            "certificate_type": "QSO_ATTRIBUTION_STATE_CERTIFICATE",
            "qso_instance": self.qso_instance,
            "entry_count": len(self.entries),
            "latest_entry_sha256": self.entries[-1]["entry_sha256"] if self.entries else None,
            "journey_sha256": canonical_sha256(self.entries),
            "epigraph": EPIGRAPH,
    ...
    def write(self, directory: Path) -> None:
        ...
        ledger_path = directory / "attribution-journey.jsonl"
